...
# the jsonic grammar, the JSON core and the fixture runner). Those entries
# legitimately move whenever the sibling checkouts do, and exempting exactly
# them is what makes a full comparison usable here when blanket `--locked`
# is not.
